...
const Documents: React.FC = () => {
  ...
  //     closeIcon: [],
  //     message: 'HarrisburgHydroponics Oracle answer ready',
  //     description: arg,
              ...
              <Col span={12} xl={12} lg={24} md={24} sm={24}>
                <Row gutter={24}>
                    ...
                    extra={
                      <Space>
                        <Badge
                          ...
                          count={'HarrisburgHydroponics'}
                          style={{ backgroundColor: '#6500FF' }}
                        />
                        <a
                          href="https://github.com/DylanAlloy/HarrisburgHydroponics-api-altdata/tree/main/routes/leaks"
                          target="_blank"
                          rel="noreferrer"
                        >
                          Source
                  ...
                  >
                    ...
                    <br />
                    <br />
                    Using these leaked documents, it is easy to pair with HarrisburgHydroponics to
                    save time reading and collect a &quot;greater-than-parts&quot; understanding
                    from several premium sources.
                  </Card>
                </Row>
                <Row>
                  ...
                  <Card
                    ...
                    extra={
                      <Space>
                        ...
                        />
                        <a
                          href="https://github.com/DylanAlloy/HarrisburgHydroponics-api-ml/blob/main/pdf_sentiment.py"
                          target="_blank"
                          rel="noreferrer"
                        >
                          Source
